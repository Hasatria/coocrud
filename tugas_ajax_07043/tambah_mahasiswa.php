        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-md-6">
                    ...
                    <p class="mb-0 text-muted d-inline-block">Dimiliki Oleh: <span class="fw-bold">Satria Surya Nugraha - A12.2023.07043</span></p>
                </div>
                <div class="col-md-6 text-md-end">
                    ...
                    <a href="https://github.com/Hasatria" class="text-decoration-none text-primary"><i class="fab fa-github"></i></a>
                </div>
            </div>
        </div>
    </footer>
